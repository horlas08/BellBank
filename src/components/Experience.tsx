        ...
        <div className=" flex flex-col items-center justify-start py-20 px-[136px] gap-[100px]">
            ...
            <div className="w-full mx-auto flex flex-col items-center justify-start gap-[80px]">
                <ExperienceItem title={'Debit cards'} subtitle={'Instant Debit cards that always work'}>
                    <div
                        ...
                        <div className="flex justify-center items-center w-full  gap-4 h-full">
                            <div className="relative w-[198px] h-[274.2px]">

                                <div
                                    className="absolute bottom-0 rounded-[50%] [background:radial-gradient(50%_50%_at_50%_50%,_rgba(0,_0,_0,_0.6),_rgba(0,_0,_0,_0))] w-[169.4px] h-[5.7px]"/>
               ...
               <ExperienceItem title={'PERSONAL ACCOUNT'} subtitle={'One app for all your banking needs'}>
                    <div
                        className="rounded-11xl bg-darkslategray-500 box-border w-[677px] h-[437px] overflow-hidden mix-blend-normal border-[8px] border-solid border-whitesmoke-100">
                ...
                <ExperienceItem subtitle={'A fully integrated suite of financial and payments products'}>
                    ...
                    <div
                        className="rounded-11xl bg-whitesmoke-100 box-border flex-1 h-[437px] overflow-hidden mix-blend-normal border-[8px] border-solid border-whitesmoke-100">
                        <div className="flex justify-center items-center w-full  gap-4 h-full">
