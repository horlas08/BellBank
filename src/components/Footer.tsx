  ...
  return (
    ...
    >
      <div className="absolute top-[864px] left-[0px] w-[1200px] h-10">
        <div className="absolute top-[22px] left-[calc(50%_-_132px)] leading-[18px]">
      ...
      <div className="absolute top-[0px] left-[0px] flex flex-col items-start justify-start gap-[50px] text-left text-sm text-white">
        <div className="w-[1199px] relative rounded-3xl bg-cadetblue h-[440px] overflow-hidden shrink-0 text-38xl">
          ...
          />
          <div className="absolute top-[calc(50%_-_147px)] left-[66px] flex flex-col items-start justify-start gap-[30px]">
        ...
        <div className="w-[1199px] relative leading-[22px] text-gray-100 flex items-center">
        ...
        <div className="w-[1200px] flex flex-row items-start justify-start text-gray-500">
          ...
          <div className="flex-1 relative h-[207px]">
            ...
            <div className="absolute w-[calc(100%_-_59.4px)] top-[33px] right-[29.5px] left-[29.9px] flex flex-col items-start justify-center pt-[3.8px] pb-[4.8px] pr-[112.6px] pl-0 box-border gap-[8.6px] text-gray-100">
          ...
          <div className="flex-1 relative h-[207px]">
            ...
            <div className="absolute w-[calc(100%_-_59.4px)] top-[33px] right-[29.5px] left-[29.9px] flex flex-col items-start justify-center pt-[3.8px] pb-[4.8px] pr-[40.2px] pl-0 box-border gap-[8.6px] text-gray-100">
              <div className="flex flex-row items-start justify-start pt-0 px-0 pb-[0.6px]">
          ...
          <div className="flex-1 h-[207px] flex flex-col items-start justify-start pt-0 px-[29.9px] pb-[131.3px] box-border gap-[12px]">
            <div className="relative leading-[21px]">Get in touch</div>
            <div className="w-[179.6px] flex flex-col items-start justify-center pt-[3.8px] pb-[4.8px] pr-[92.5px] pl-0 box-border gap-[8.6px] text-gray-100">
          ...
          <div className="flex-1 h-[207px] flex flex-col items-start justify-start py-0 px-[29.9px] box-border gap-[12px]">
            ...
            <div className="w-[179.6px] flex flex-col items-start justify-start gap-[12px] text-xs text-gray-100">
              <div className="w-[179.6px] rounded-md bg-white box-border flex flex-row items-start justify-start pt-[11px] px-[15px] pb-2.5 z-[1] border-[1px] border-solid border-whitesmoke-600">
                <div className="w-[149.6px] overflow-hidden shrink-0 flex flex-row items-start justify-start py-0 pr-[93.6px] pl-0 box-border">
                  <div className="relative">Your email</div>
                </div>
              </div>
              <div className="w-[179.6px] rounded-md bg-mediumseagreen flex flex-row items-start justify-center pt-1.5 pb-[7.4px] pr-[68.7px] pl-[69.8px] box-border z-[0] text-center text-white">
